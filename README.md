...
[![My Skills](https://skillicons.dev/icons?i=py,cpp,java,pytorch,tensorflow,opencv,scikitlearn,numpy,pandas,fastapi,docker,sqlite,git,linux)](https://skillicons.dev)
...
<sub>Colorful variant, generated by the same workflow:</sub>
